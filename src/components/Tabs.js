...
export function TabList({ children, html, css, js, loadingResponse, downloadFunction }) {
    ...
    const loading_screen = loadingResponse ? (
    ...
    return (
        <div className="tablist-container">
            <div className="tablist-header">
                ...
                {/* Including the "External Link" tab */}
                <div
                    className={`tablist-tab ${activeTab === "external" ? "active" : ""}`}
                    onClick={() => handleChangeTab("external")}
                >
                    <SlIcon name="link" label="External Link" />
